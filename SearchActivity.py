...
class SearchActivity(activity.Activity):
    ...
    def _restore(self):
        ...
        if 'dotlist' in self.metadata:
            ...
            self._game.restore_game(dot_list, self.colors)
    ...
    def _setup_dispatch_table(self):
        ...
        self._processing_methods = {
            'new_game': [self._receive_new_game, 'get a new game grid'],
            'played': [self._receive_dot_click, 'get a dot click'],
        }
    ...
    def send_new_game(self):
        ...
        self.send_event('new_game',self._game.save_game())

    def _receive_new_game(self, payload):
        ''' Sharer can start a new game. '''
        dot_list, colors = payload
        self._game.restore_game(dot_list, colors)

    def send_dot_click(self, dot, color):
        ''' Send a dot click to all the players '''
        self.send_event('played', (dot, color))
